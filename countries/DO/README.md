# Dominican Republic — Phone Number Formats
...
| --- | --- | --- | --- | --- |
| fixed-line | `+18092211234` | `+1 809 221 1234` | `(809) 221-1234` | Santo Domingo — 809 is the original area code |
| fixed-line | `+18295551234` | `+1 829 555 1234` | `(829) 555-1234` | Dominican Republic — 829 overlay, added 2005 |
