...
| --- | --- | --- | --- | --- |
| fixed-line | `+14163631234` | `+1 416 363 1234` | `(416) 363-1234` | Toronto, ON — area code 416 |
| fixed-line | `+16046821234` | `+1 604 682 1234` | `(604) 682-1234` | Vancouver, BC — area code 604 |
| toll-free | `+18005551234` | `+1 800 555 1234` | `(800) 555-1234` | Toll-free — shared with the rest of the NANP |
