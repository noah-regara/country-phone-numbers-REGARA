...
| --- | --- | --- | --- | --- |
| fixed-line | `+18769261234` | `+1 876 926 1234` | `(876) 926-1234` | Kingston — 876 is the original area code |
| fixed-line | `+16585551234` | `+1 658 555 1234` | `(658) 555-1234` | Jamaica — 658 overlay, added 2018 |
