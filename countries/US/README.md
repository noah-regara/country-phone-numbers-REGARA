# United States of America — Phone Number Formats
...
| --- | --- | --- |
| Geographic (fixed or mobile) | `(NPA) NXX-XXXX` | `+1 NPA NXX XXXX` |
| Toll-free (shared NANP-wide) | `(800) NXX-XXXX` | `+1 800 NXX XXXX` |

## Examples

| Type | E.164 | International | National | Notes |
| --- | --- | --- | --- | --- |
| fixed-line | `+12127361234` | `+1 212 736 1234` | `(212) 736-1234` | New York City, NY — area code 212 covers Manhattan |
| fixed-line | `+14156261234` | `+1 415 626 1234` | `(415) 626-1234` | San Francisco, CA — area code 415 |
| toll-free | `+18005551234` | `+1 800 555 1234` | `(800) 555-1234` | Toll-free — 800/888/877/866/855/844/833 are shared NANP-wide |
